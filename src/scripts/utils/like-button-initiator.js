import FavouriteRestaurantIdb from '../data/favorite-resto';
import { createLikeButtonTemplate, createLikedButtonTemplate } from '../views/templates-api/template-detail-creator';
